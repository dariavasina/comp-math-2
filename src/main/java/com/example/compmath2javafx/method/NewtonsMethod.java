...
public class NewtonsMethod implements SystemMethod {

    public Result compute(SystemOfEquations system, double x0, double y0, double accuracy, int digitsAfterComma) {
        System.out.println("computing");
        Kramer kramer = new Kramer();
        TwoVariableFunction function1 = system.getFunctions()[0];
        TwoVariableFunction function2 = system.getFunctions()[1];
